...
//             <span className="text-[12px] font-semibold text-slate-800 tracking-tight whitespace-nowrap">
...
//             {formatToINR(row.original.txnAmount)}
//           </span>
//         ),
//       },
//       {
...
//               }
//               className="h-8 w-8 bg-indigo-600 border border-slate-900 rounded-xl text-white hover:text-white hover:bg-indigo-700 hover:border-slate-800 transition-all shadow-sm hover:shadow-md hover:-translate-y-0.5 duration-150"
//             >
...
//       <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 px-2 mb-2">
//         <StatCard
//           label="Total Success"
...
//       {/* <div className="mx-2 rounded-[2rem] border border-indigo-200/60 bg-gradient-to-tr from-white via-white to-indigo-50/40 shadow-sm overflow-hidden relative z-10 transition-all"> */}
