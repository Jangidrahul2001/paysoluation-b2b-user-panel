...
// export default function AepsResponseModal({ responseData, onClose, transactionType }) {
//   console.log(responseData, "AepsResponseModal Data");
...
//                   {/* Balance Display */}
//                   {(transactionType === 'balance' && responseData?.data?.balance) && (
//                     <div className="mt-4">
//                       <p className="text-white/70 text-xs uppercase tracking-wider mb-1">
//                         Available Balance
//                       </p>
//                       <p className="text-3xl font-black">
//                         {formatToINR(responseData?.data?.balance)}
//                       </p>
//                     </div>
//                   )}

//                   {/* Withdrawal Amount */}
//                   {(transactionType === 'withdrawal' && responseData.transactionValue) && (
//                     <div className="mt-4">
//                       <p className="text-white/70 text-xs uppercase tracking-wider mb-1">
//                         Withdrawal Amount
//                       </p>
...
//                   {responseData?.data?.aadhaarNumber && (
//                     <div className="flex justify-between items-center">
...
//                       {responseData?.data?.miniStatement.map((transaction, index) => {
//                         console.log(transaction.narration
//                           ?.split(transaction.amount)?.[0]?.trim().match(/([A-Za-z])$/)?.[1])
//                         const transactionType =
//                           transaction.narration
//                             ?.split(transaction.amount)?.[0]?.trim().match(/([DC])$/)?.[1] || "D";
